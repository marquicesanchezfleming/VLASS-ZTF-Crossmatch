...
def generate_html():
    # Load the CSV file
    csv_path = '/Users/Djslime07/PycharmProjects/Rewriting /bts_data.CSV'
    df = pd.read_csv(csv_path)

    diff_days_path = "/Users/Djslime07/PycharmProjects/Rewriting /CSV's/Difference_in_Days.csv"
    ...
    images_folder_path = "/Users/Djslime07/PycharmProjects/Rewriting /Images"
...
'''
    ...
    for index, row in df.iterrows():
        ...
        leg_survey_image_path = f"Images/{leg_survey_image_filename}"
...
'''
    ...
    output_path = "/Users/Djslime07/PycharmProjects/Rewriting /please_work.html"
